/*
  File: app/ai-slot.tsx
  Include:
  - Punteggi bonus e wild
  - Glow e pulsazione
  - Rulli che si fermano a ritardo
  - Linea rossa tra i simboli vincenti (anche sparsi)
*/
...
export default function AiSlot() {
  ...
  const getLinePosition = () => {
    ...
    return coords.every(c => c !== null) ? coords as { x: number, y: number }[] : null;
  };

  const styles = {
    ... // come prima (omesso per spazio)
  };

  const winningLine = getLinePosition();
